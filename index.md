...
![frink](frink.png)
 ...
 - Maintainer of several R packages (jsonlite, webutils, ...)
...
![rstudio](rstudio.png)
 ...
 - Fun, write interactive webapps in R
 - Reactive programming framework
 - Built-in widgets, no webdev needed.
...
![docker](docker.png)
 ...
 - Very fast (start/stop vm in milliseconds)
 - Isolates file system, HW resources 
 - Create images, fork from images
 - Used by Shiny Server for sandboxing
 - Also great for reproducible research
...
#### Where we are going:
- Facebook of data.
- Socialize data, analysis, results
- Simplify Peer review, teaching, transparency, collaboration.

#### What everyone does:
- Scaling bigger data
- Analysis as a service
- GUIs, interactive graphics
